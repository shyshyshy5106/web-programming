<?php
    ...
    class Profiles extends Database{
        ...
        public function addProfile(){
            ...
            $sql = "INSERT INTO profile(role_id, fname, mname, lname, phone_num, email, address, sex, dob, join_date, status, created_at, updated_at) VALUES(:role_id, :fname, :mname, :lname, :phone_num, :email, :address, :sex, :dob, :join_date, :status, :created_at, :updated_at)";
            $query = $this->connect()->prepare($sql);
        ...
        public function editProfile($pid){
            ...
            $sql = "UPDATE profile SET role_id = :role_id, fname = :fname, mname = :mname, lname = :lname, phone_num = :phone_num, email = :email, address = :address, sex = :sex, dob = :dob, join_date = :join_date, status = :status, created_at = :created_at, updated_at = :updated_at WHERE id = :id";
            $query = $this->connect()->prepare($sql);
            $query->bindParam(":role_id", $this->role_id, PDO::PARAM_INT);
            $query->bindParam(":fname", $this->fname);
            $query->bindParam(":mname", $this->mname);

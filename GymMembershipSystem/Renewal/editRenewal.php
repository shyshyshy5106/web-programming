     ...
     <main class="page-container">
        <section class="form-card">
                ...
                <div class="footer-actions">
                    <button type="submit" class="btn btn-primary" value="Update Renewal">Update Renewal</button>
                    <button><a class="btn btn-outline" href="viewRenewal.php">View Renewals</a></button>
                </div>

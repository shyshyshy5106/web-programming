    ...
    <section class="form-card">
        ...
        <form action="" method="POST">
                    ...
                    <?php if (!empty($roles)) : ?>
                        <?php foreach ($roles as $role) : ?>
                            <option value="<?= $role['role_id'] ?>" 
                                <?= (isset($profile['role_id']) && $profile['role_id'] == $role['role_id']) ? 'selected' : '' ?>>
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" name="phone_num" id="phone_num" maxlength="11" 
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="date" name="join_date" id="join_date" 
                    value="<?= $profile['join_date'] ?? date('Y-m-d') ?>">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="datetime-local" name="created_at" id="created_at" 
                    value="<?= $profile['created_at'] ?? date('Y-m-d\TH:i') ?>">
                <p class="error"><?= $errors['created_at'] ?? '' ?></p>
            </div>

            <div class="form-group">
                <label for="updated_at">Updated At <span class="required">*</span></label>
                <input class="form-control" type="datetime-local" name="updated_at" id="updated_at" 
                    value="<?= $profile['updated_at'] ?? date('Y-m-d\TH:i') ?>">
                <p class="error"><?= $errors['updated_at'] ?? '' ?></p>
            </div>

            <div class="footer-actions">
                <button type="submit" class="btn btn-primary">Save Profile</button>
                <button><a class="btn btn-outline" href="viewProfile.php">View Profiles</a></button>
            </div>

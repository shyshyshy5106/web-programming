...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        if (!$profileObj->isProfileExist($profile["fname"], $profile["lname"], $profile["role_id"], $profile_id) &&
            $profileObj->editProfile($profile_id)) {
            header("Location: viewProfile.php");
            exit();
        } else {
            $errors["general"] = "Failed to update profile. Either the profile already exists or there was a database error.";
        }
    }
}
?>
    ...
    <main class="page-container">
        <section class="form-card">
                ...
                <div class="footer-actions">
                    <input type="submit" class="btn btn-primary" value="Update Profile"><button><a class="btn btn-outline" href="viewProfile.php">Cancel</a></button>
                    </div>
                </form>
        </section>
    </main>

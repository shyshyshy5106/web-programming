<?php
    ...
    if(isset($_GET["plan_id"]))
    {
        ...
        if(!$membership_plans)
        {
            echo "<a href= 'viewPlan.php' > View Plans </a>";
            exit("Plan Not Found!");
        }
    } else {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        } elseif ($plansObj->isPlanExist($membership_plans["plan_name"], $_GET["plan_id"])){
        $errors["plan_name"] = "Plan name already exist.";
    }
        ...
        if (empty(array_filter($errors))) {
            ...
            if($plansObj->editPlan($_GET["plan_id"])){
...
<head>
    ...
    <title>Edit Membership Plans</title>
    <link rel="stylesheet" href="../index.css">
</head>
<body>
     <main class="page-container">
        <section class="form-card">
                <h1> Update Membership Plan </h1>
                ...
                <div class="footer-actions">
                    <button type="submit" class="btn btn-primary" value="Update Plan">Update Plan</button><button><a class="btn btn-outline" href="viewPlan.php">Cancel</a></button></span>
                    </div>
                </form>
        </section>
     </main>

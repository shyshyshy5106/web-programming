...
<body>
    ...
    <table border="1">
        ...
        foreach($booksObj->viewBook($search, $genre)as $books) {
            $message = "Are you sure you want to delete this book ". $books["title"] . "?";
        ?>
            ...
            <tr class="dataRow">
                ...
                <td> <?= $books["copies"] ?> </td>
                <td>
                    <a style="text-decoration: none; color: #751717;" href="editBook.php?id=<?= $books["id"] ?>">Edit</a>
                    <a style="text-decoration: none; color: #751717;" href="deleteBook.php?id=<?= $books["id"] ?>" onclick="return confirm('<?= $message ?>')">Delete</a>
            </tr>
